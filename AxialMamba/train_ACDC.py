...
from my_datasets.dataset_ACDC import ACDCdataset, RandomGenerator
import argparse
...
from models.utils import SegmentationLogger2
...
parser.add_argument("--save_path", default=r".\path\acdc_log\4\train")
parser.add_argument("--n_gpu", default=1)
parser.add_argument("--checkpoint", default=None)
parser.add_argument("--list_dir", default=r".\path\lists_ACDC")
parser.add_argument("--root_dir", default=r".\root_path")
parser.add_argument("--volume_path", default=r".\path\test")
parser.add_argument("--z_spacing", default=10)
parser.add_argument("--num_classes", default=4)
parser.add_argument('--test_save_dir', default=r'.\test_path', help='saving prediction as nii!')
parser.add_argument("--patches_size", default=16)
parser.add_argument("--n_skip", default=1)
args = parser.parse_args()

model = MAAmamba_unet8(num_classes=args.num_classes, in_channels=1, width=args.img_size)  # 4
...
logger = SegmentationLogger2(save_dir=args.test_save_dir)
...
for epoch in iterator:
    ...
    if (epoch + 1) % save_interval == 0:
        ...
        if avg_dcs > Best_dcs:
            ...
            # temp = 1
            Best_dcs = avg_dcs
            avg_dcs, avg_hd, miou = inference(args, model, testloader, args.test_save_dir)
            logger.record_metrics(epoch=epoch,
                                  avg_dsc=avg_dcs,
                                  avg_hd=avg_hd,
                                  avg_iou=miou)
